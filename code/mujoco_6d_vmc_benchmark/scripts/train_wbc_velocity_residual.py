...
def main() -> None:
    ...
    metadata = {
        "algorithm": {
            ...
            "fan_ye_forecast_wbc_esn": "PPO readout over current WBC state/errors; fixed ESN future-error forecast causally softens fixed-WBC feedback during predicted departure",
            "fan_ye_phase_predictive_wbc_esn": "PPO readout over Fan Ye fast/slow state; forecast growth and causal phase memory jointly, slew-continuously modulate fixed-WBC feedback",
        ...
        "observation_contract": {
            ...
            "dimension": {"current_mlp": 32, "kinematic_forecast_mlp": 38, "fan_ye_esn": 96, "fan_ye_multiscale_esn": 160, "fan_ye_phase_esn": 160, "fan_ye_stable_phase_esn": 160, "fan_ye_closed_loop_esn": 160, "fan_ye_forecast_esn": 38, "fan_ye_forecast_authority_esn": 32, "fan_ye_forecast_wbc_esn": 32, "fan_ye_phase_predictive_wbc_esn": 160}[args.observation_mode],
            "current_input": ["q(7)", "qdot(7)", "fixed_WBC_task_twist(6)", "measured_WBC_pose_error(6)", "measured_WBC_twist_error(6)"],
            "reservoir_state_dimension": {"current_mlp": 0, "kinematic_forecast_mlp": 0, "fan_ye_esn": 64, "fan_ye_multiscale_esn": 128, "fan_ye_phase_esn": 128, "fan_ye_stable_phase_esn": 128, "fan_ye_closed_loop_esn": 128, "fan_ye_forecast_esn": 128, "fan_ye_forecast_authority_esn": 128, "fan_ye_forecast_wbc_esn": 128, "fan_ye_phase_predictive_wbc_esn": 128}[args.observation_mode],
            ...
            "forecast": None if args.observation_mode not in ("kinematic_forecast_mlp", "fan_ye_forecast_esn", "fan_ye_forecast_authority_esn", "fan_ye_forecast_wbc_esn", "fan_ye_phase_predictive_wbc_esn") else (
